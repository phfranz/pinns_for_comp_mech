...
Quarter_Disc = QuarterDisc(radius=radius, center=center, mesh_size=0.01, angle=265, refine_times=100, gmsh_options=gmsh_options)
...
nu_actual = 0.3
e_predicted = e_actual#dde.Variable(180.0) #initial guess
...
ext_traction_predicted= dde.Variable(-100.0)
...
parameter_file_name = str(Path(__file__).parent)+"/hertzian_inverse_p_100.dat"
